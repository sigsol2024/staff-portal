...
class PHPMailer
{
    ...
    public static function isValidHost($host)
    {
        ...
        // FILTER_FLAG_HOST_REQUIRED may not exist on very old PHP builds; fall back safely
        $filterHostRequired = \defined('FILTER_FLAG_HOST_REQUIRED') ? \FILTER_FLAG_HOST_REQUIRED : 0;
        if (filter_var('http://' . $host, \FILTER_VALIDATE_URL, $filterHostRequired)) {
